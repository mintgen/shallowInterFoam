...
namespace Foam
{
    defineTypeNameAndDebug(sifMappedPatchBase, 0);

    template<>
    const char* NamedEnum<sifMappedPatchBase::sampleMode, 3>::names[] =
    {
        "nearestCell",
        "nearestPatchFace",
        "nearestFace"
    ...
    const NamedEnum<sifMappedPatchBase::sampleMode, 3>
        sifMappedPatchBase::sampleModeNames_;
...
void Foam::sifMappedPatchBase::collectSamples
(
    pointField& samples,
...
void Foam::sifMappedPatchBase::findSamples
(
...
) const
{
    ...
    if (debug)
    {
        Info<< "sifMappedPatchBase::findSamples on mesh " << sampleRegion_
            << " : " << endl;
        ...
        forAll (nearest, sampleI)
        {
            ...
            Info<< " samples:" << samples << endl;
            Info<< " nearest:" << nearest << endl;
        }
    }
    ...
    forAll (nearest, sampleI)
    {
        if (!nearest[sampleI].first().hit())
        {
            FatalErrorIn
            (
                "sifMappedPatchBase::findSamples"
...
void Foam::sifMappedPatchBase::calcMapping() const
{
    if (mapPtr_.valid())
    {
        FatalErrorIn("sifMappedPatchBase::calcMapping() const")
    ...
    {
        WarningIn("sifMappedPatchBase::calcMapping() const")
...
Foam::sifMappedPatchBase::sifMappedPatchBase
(
    const polyPatch& pp
)
:
...
void Foam::sifMappedPatchBase::clearOut()
{
    mapPtr_.clear();
}
...
const Foam::polyMesh& Foam::sifMappedPatchBase::sampleMesh() const
{
...
const Foam::polyPatch& Foam::sifMappedPatchBase::samplePolyPatch() const
{
    ...
    if (patchI == -1)
    {
        FatalErrorIn("sifMappedPatchBase::samplePolyPatch() ")
...
void Foam::sifMappedPatchBase::write(Ostream& os) const
{
